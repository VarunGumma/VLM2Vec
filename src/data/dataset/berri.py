...
def load_berri(
    ...
    **kwargs,
    ...
    add_prompt_ratio = (
        kwargs.pop("add_prompt_ratio") if "add_prompt_ratio" in kwargs else 1.0
    )
    ...
    if query_prompt_type:
        query_prompt = AutoPrompt.instantiate(
            prompt_family=query_prompt_type, task_name=dataset_name
        )["q_prompt"]
    if doc_prompt_type:
        doc_prompt = AutoPrompt.instantiate(
            prompt_family=doc_prompt_type, task_name=dataset_name
        )["d_prompt"]
