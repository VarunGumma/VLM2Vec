...
TARGET_INSTRUCTION = (
    "Generate an embedding for the following document, in the format of images: "
)
...
def data_prepare(batch_dict, *args, **kwargs):
    ...
    for query, doc_id, neg_doc_ids in zip(
        batch_dict["query_text"],
        batch_dict["positive_document_ids"],
        batch_dict["negative_document_ids"],
    ):
