...
sfr_prompts_map_deprecated = {
    ...
    "allnli": {
        "q_prompt": "Represent this sentence to retrieve sentences that are semantically entailed by it",
    ...
    "bioasq": {
        "q_prompt": "Retrieve bio-medical scientific paper paragraph to answer this question",
...
def load_sfe_prompt(task_name, task_type="Retrieval", *args, **kwargs):
    ...
    assert (
        task_name in sfr_prompts_map_deprecated
    ), f"Unsupported dataset name {task_name}"
...
def load_sfr_prompt(
    task_name,
    task_type,
    add_choices_in_prompt=False,
    add_taskname_in_docprompt=False,
    *args,
    **kwargs,
):
