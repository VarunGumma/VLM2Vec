...
EVAL_DATASET_HF_PATH = {
    # Video-RET
    "MSR-VTT": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "MSR-VTT"),
        "test_1k",
        "test",
    ),
    ...
    "YouCook2": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "YouCook2"),
        None,
        "val",
    ),
    ...
    "Breakfast": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "Breakfast"),
        None,
        "test",
    ),
    "Kinetics-700": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "Kinetics-700"),
        None,
        "test",
    ),
    "SmthSmthV2": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "SmthSmthV2"),
        None,
        "test",
    ),
    # Video-MRET
    "QVHighlight": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "QVHighlight"),
        None,
        "test",
    ),
    "Charades-STA": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "Charades-STA"),
        None,
        "test",
    ),
    "MomentSeeker": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "MomentSeeker"),
        None,
        "test",
    ),
    "MomentSeeker_1k8": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "MomentSeeker_1k8"),
        None,
        "test",
    ),
    # Video-QA
    ...
    "EgoSchema": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "EgoSchema"),
        "Subset",
        "test",
    ),
    "MVBench": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "MVBench"),
        None,
        "train",
    ),
    "Video-MME": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "Video-MME"),
        None,
        "test",
    ),
    "ActivityNetQA": (
        os.path.join(BASE_RAW_DATA_DIR, "video-tasks", "ActivityNetQA"),
        None,
        "test",
    ),
    # Visdoc-ViDoRe
    "ViDoRe_arxivqa": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "arxivqa_test_subsampled_beir"),
        None,
        "test",
    ),
    "ViDoRe_docvqa": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "docvqa_test_subsampled_beir"),
        None,
        "test",
    ),
    "ViDoRe_infovqa": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "infovqa_test_subsampled_beir"),
        None,
        "test",
    ),
    "ViDoRe_tabfquad": (
        os.path.join(
            BASE_RAW_DATA_DIR, "visdoc-tasks", "tabfquad_test_subsampled_beir"
        ),
        None,
        "test",
    ),
    "ViDoRe_tatdqa": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "tatdqa_test_beir"),
        None,
        "test",
    ),
    "ViDoRe_shiftproject": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "shiftproject_test_beir"),
        None,
        "test",
    ),
    ...
    "ViDoRe_syntheticDocQA_energy": (
        os.path.join(
            BASE_RAW_DATA_DIR, "visdoc-tasks", "syntheticDocQA_energy_test_beir"
        ),
        None,
        "test",
    ),
    ...
    # Visdoc-VisRAG
    "VisRAG_ArxivQA": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "VisRAG-Ret-Test-ArxivQA"),
        None,
        "train",
    ),
    "VisRAG_ChartQA": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "VisRAG-Ret-Test-ChartQA"),
        None,
        "train",
    ),
    "VisRAG_MP-DocVQA": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "VisRAG-Ret-Test-MP-DocVQA"),
        None,
        "train",
    ),
    "VisRAG_SlideVQA": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "VisRAG-Ret-Test-SlideVQA"),
        None,
        "train",
    ),
    "VisRAG_InfoVQA": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "VisRAG-Ret-Test-InfoVQA"),
        None,
        "train",
    ),
    "VisRAG_PlotQA": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "VisRAG-Ret-Test-PlotQA"),
        None,
        "train",
    ),
    # Visdoc-ViDoSeek
    "ViDoSeek-doc": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "ViDoSeek"),
        None,
        "test",
    ),
    "ViDoSeek-page": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "ViDoSeek-page"),
        None,
        "test",
    ),
    "MMLongBench-doc": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "MMLongBench-doc"),
        None,
        "test",
    ),
    "MMLongBench-page": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "MMLongBench"),
        None,
        "test",
    ),
    # Visdoc-ViDoRe_v2
    "ViDoRe_esg_reports_human_labeled_v2": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "esg_reports_human_labeled_v2"),
        None,
        "test",
    ),
    "ViDoRe_biomedical_lectures_v2": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "biomedical_lectures_v2"),
        "english",
        "test",
    ),
    ...
    "ViDoRe_economics_reports_v2": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "economics_reports_v2"),
        "english",
        "test",
    ),
    ...
    "ViDoRe_esg_reports_v2": (
        os.path.join(BASE_RAW_DATA_DIR, "visdoc-tasks", "esg_reports_v2"),
        "english",
        "test",
    ),
    ...
    # Image-CLS
    "ImageNet-1K": (
        os.path.join(BASE_RAW_DATA_DIR, "image-tasks"),
        "ImageNet-1K",
        "test",
    ),
